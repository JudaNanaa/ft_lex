...
use crate::{
    ...
    lex_creation::{functions::{yy_action::yy_action, yy_final::yy_final, yy_search_final::create_yy_search_final}, tables::table::tables_creation, write::{write_defines, write_includes, write_user_routine, write_variables, write_yy_add_buffer, write_yy_fatal_error, write_yy_if_match, write_yy_if_no_match, write_yy_increase_accepting_stack_len, write_yy_init_accepting_stack, write_yy_init_buffer, write_yy_next_char, write_yy_pop_accepting_state, write_yy_push_accepting_state, write_yy_reject, write_yy_set_yytext, write_yylex}, LEX_FILE
    },
};
